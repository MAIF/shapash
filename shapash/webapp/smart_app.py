...
class SmartApp:
    ...
    def init_data(self, rows=None):
        ...
        elif self.explainer.columns_order == "additional_data_first":
                            ...
                            html.Div(
                                ...
                                children=[
                                    ...
                                    dbc.Modal(
                                        [
                                            dbc.ModalHeader(
                                                dbc.ModalTitle("Filters explanation", style={"font-size": "1.5vw"})
                                            ),
                            ...
                            dbc.Modal(
                                [
                                    dbc.ModalHeader(
                                        dbc.Col(
                                            [
                                                dbc.ModalTitle("Identity Card", style={"font-size": "1.5vw"}),
                                                dbc.Row(
                                                    [
                                            ...
                                            [
                                                ...
                                                dbc.Modal(
                                                    [
                                                        ...
                                                        dbc.ModalHeader(
                                                            dbc.ModalTitle(
                                                                "Feature importance", style={"font-size": "1.5vw"}
                                                            )
                                                        ),
                                                        dbc.ModalBody(
                                                            [
                                                    ...
                                                    [
                                                        ...
                                                        dbc.Modal(
                                                            [
                                                                dbc.ModalHeader(
                                                                    dbc.ModalTitle(
                                                                        "Feature selector", style={"font-size": "1.5vw"}
                                                                    )
                                                                ),
                                                                dbc.ModalBody(
                                                                    [
        ...
        for component_id, component_type in components_to_init.items():
            ...
            def ember(
                ...
                if toggle_on:
                    ...
                    style_component = {"height": "91vh", "maxHeight": "93vh"}
    ...
    def callback_generator(self):
        ...
        def update_datatable(
            ...
            selected_data = selected_data_prediction_picking or selected_data_clusters
            prediction_tabs = [
                "prediction_picking.selectedData",
                "clusters.selectedData",
            ]
        ...
        def update_id_card(n_submit, label, sort_by, order, data, index):
            ...
            if n_submit and selected is not None:
                ...
                if self.explainer._case == "classification":
                    ...
                    proba = self.explainer._local_pred(index, label_num)
        ...
        @app.callback(
            Output("modal_clusters", "is_open"),
            [Input("open_clusters", "n_clicks"), Input("close_clusters", "n_clicks")],
            [State("modal_clusters", "is_open")],
        )
        def toggle_modal_clusters(n1, n2, is_open):
            """
            Function used to open and close modal explication when we click
            on "?" button on clusters graph
            ---------------------------------------------------------------
            n1: click on "?" button
            n2: click on close button in modal
            ---------------------------------------------------------------
