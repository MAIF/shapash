...
REPORT_STYLES = """
    ...
    *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
    ...
    .sidebar {
        ...
        overflow-y: auto;
        box-shadow: inset -8px 0 12px -12px rgba(0, 0, 0, 0.45);
    }
    .sidebar-brand {
    ...
    .nav-group-title {
        ...
        padding: 10px 0; display: block; text-decoration: none; transition: 0.2s;
    }
    .nav-group-title:hover { color: #551a8b; }
    .nav-group-title.active {
        color: #551a8b; font-weight: bold; border-left: 3px solid #551a8b; padding-left: 10px;
    }
    .nav-children { display: block; }
    .nav-child {
        color: var(--text-light); padding: 6px 0 6px 16px; display: block;
        text-decoration: none; font-size: 12px; transition: 0.2s;
    }
    .nav-child:hover { color: var(--text-main); }
    .nav-child.active {
        color: #551a8b; font-weight: 600; border-left: 3px solid #551a8b; padding-left: 13px;
    }
    ...
    .section-title { font-size: 1.6rem; color: #000; margin: 40px 0 20px; font-weight: 700; }
    ...
    .kv-table thead th, table.dataframe thead th {
        background: #fafafa;
        color: #000;
        font-weight: 700;
        text-align: left;
    ...
    .kv-table tbody th, table.dataframe tbody th {
        color: #000;
        font-weight: 600;
        text-align: left;
        background: #fcfcfc;
    }
    .kv-table td, .kv-table th, table.dataframe td, table.dataframe th {
        padding: 12px 16px;
    ...
    .kv-key { font-weight: 700; width: 220px; color: #000; white-space: nowrap; }
    .kv-key-label, .kv-key-sep { white-space: nowrap; }
