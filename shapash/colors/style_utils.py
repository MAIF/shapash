...
def define_style(palette):
    ...
    style_dict['dict_featimp_colors'] = {
        1: { 
            'color': palette["featureimp_bar"]["1"],
            'line': {
        ...
        2: {
            'color': palette["featureimp_bar"]["2"]
        }
    }
    style_dict['featureimp_groups'] = palette["featureimp_groups"]
    style_dict['init_contrib_colorscale'] = palette["contrib_colorscale"]
    style_dict['violin_area_classif']  = {
        1: palette["violin_area_classif"][1],
        0: palette["violin_area_classif"][0]
    }
    style_dict['violin_default'] = palette["violin_default"]
    style_dict['self.dict_title_compacity'] = {
        'font': {
            'size': 14,
            'family': "Arial",
            'color': palette["title_color"]
    ...
    style_dict['dict_local_plot_colors'] = {
        1: {
            'color': palette["localplot_bar"]["1"],
            'line': {
                'color': palette["localplot_line"]["1"],
                'width': 0.5
            }
        },
        -1: {
        ...
        0: {
            'color': palette["localplot_bar"]["0"],
            'line': {
                'color': palette["localplot_line"]["0"],
                'width': 0.5
            }
        },
        -2: {
            'color': palette["localplot_bar"]["-2"],
            'line': {
                'color': palette["localplot_line"]["-2"],
                'width': 0.5
            }
        }
    }
    style_dict['dict_compare_colors'] = palette["compare_plot"]
    style_dict['dict_stability_bar_colors'] = {
        1: palette["stability_bar"]["1"],
        0: palette["stability_bar"]["0"]
    }
    style_dict['dict_compacity_bar_colors'] = {
        1: palette["compacity_bar"]["1"],
        0: palette["compacity_bar"]["0"]
    }
